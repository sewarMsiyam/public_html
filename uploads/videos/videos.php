...
class Videos_AppAdmin extends Intro_AppsAdmin{
	...
	function nav(){
		...
		echo "<ul class=\"nav justify-content-center mb-2\">
				  <li class=\"nav-item mx-2\">
					...
					<i class=\"px-2 fa-solid fa-box-open\"></i> ".$intro->lang["videos_appname"]." </a>
				  </li>
				  <li class=\"nav-item mx-2\">
	...
	function index(){
		...
		$result = $intro->db->query("SELECT * from ".PREFIX."_videos WHERE true $qry order by $order  limit $nexlimit,$rows_per_page");
	...
	echo "<div class=\"card my-3 \">
			  ...
			  <div class=\"card-body nopadding\">
				<form class=\"row nopadding\"  action=\"\" method=\"post\">
				  ...
				  <div class=\"col-auto\">
					".form_select("catid",$scatid,"products_cat")."
				 </div>
				  <div class=\"col-auto\">
	...
	echo "
			...
			<tr>
				<td>".$intro->lang["videos_photo_ar"]." :  <span style='color:#ff0000'>*</span></td>
			...
			<tr>
				<td>File Arabic  : </td>
				<td><input type=file  dir=ltr  name=\"vfile_ar\" class='ltr'  >$vfile_ar</td>
			</tr>
			<tr>
				<td>File  English : </td>
				<td><input type=file  dir=ltr  name=\"vfile_en\" class='ltr'  >$vfile_en</td>
			</tr>
			
			<tr>
				<td>Details Arabic : </td>
				<td><textarea name=\"body_ar\" class='form-control' >$body_ar</textarea></td>
			</tr>
			<tr>
				<td>Details English : </td>
				<td><textarea name=\"body_en\"  class='form-control' >$body_en</textarea></td>
			</tr>
	...
	function doAdd(){
		...
		$data["body_ar"] = addslashes($body_ar);
		$data["body_en"] = addslashes($body_en);
		$data["status"] = $status;
