...
class Intro_Database
{
     ...
     */
	 ...
	 function _optimize($email,$domain, $ip){ 
    ...
    function show_debug_console($return = false)
    {
        ...
        if (
			...
			$path = $config['base_url'] . "includes/db";
